...
mixin _$DeliverInterventionEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(TaskModel task, bool isEditing,
            BoundaryModel boundaryModel, bool navigateToSummary)
        handleSubmit,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(TaskModel task, bool isEditing,
            BoundaryModel boundaryModel, bool navigateToSummary)?
        handleSubmit,
...
class _$DeliverInterventionSubmitEventImpl
  ...
  @override
  String toString() {
    return 'DeliverInterventionEvent.handleSubmit(task: $task, isEditing: $isEditing, boundaryModel: $boundaryModel, navigateToSummary: $navigateToSummary)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, task, isEditing, boundaryModel, navigateToSummary);
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return handleSubmit?.call(
        task, isEditing, boundaryModel, navigateToSummary);
  }
...
abstract class DeliverInterventionSubmitEvent
  ...
  const factory DeliverInterventionSubmitEvent(
      ...
      final bool navigateToSummary}) = _$DeliverInterventionSubmitEventImpl;

...
class AuthenticatedRouteWrapper
  ...
  AuthenticatedRouteWrapper({
    Key? key,
    required Box<ServiceRegistry> sbox,
    required Box<AppConfiguration> abox,
    List<PageRouteInfo>? children,
  }) : super(
...
class AuthenticatedRouteWrapperArgs {
  ...
  @override
  String toString() {
    return 'AuthenticatedRouteWrapperArgs{key: $key, sbox: $sbox, abox: $abox}';
  }
}
...
class UserProfileRouteArgs {
  ...
  @override
  String toString() {
    return 'UserProfileRouteArgs{key: $key, appLocalizations: $appLocalizations}';
  }
}
